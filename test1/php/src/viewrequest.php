...
$cn=mysqli_connect("db","root","MYSQL_ROOT_PASSWORD","bloodbank");
$s="select * from requestes,bloodgroup where requestes.bgroup=bloodgroup.bg_id";
	...
	{
				echo"<tr><td  style=' padding-left:50px'>$data[10]</td><td  style=' padding-left:10px'>$data[1]</td><td  style=' padding-left:20px'>$data[2]</td><td  style=' padding-left:30px'>$data[3]</td><td  style=' padding-left:50px'>$data[4]</td><td  style=' padding-left:50px'>$data[5]</td><td  style=' padding-left:60px'>$data[7]</td></tr>";
			}
			mysqli_close($cn);
			?>
...
<div class="footer">
			...
			<h1 style="font-size: 50px"><center>Save life by donating blood</center></h1>
	<div class="f_nav">
		<ul>
